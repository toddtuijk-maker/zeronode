#!/usr/bin/env bash
#
# Vendored from https://get.hy2.sh/ (official Aperture Internet Laboratory installer)
# Fetched: 2026-08-11 | Upstream: https://github.com/apernet/hysteria
# 本文件为官方安装器原样分发，仅用于随 hysteria.sh 离线/固定版本安装，避免运行时
# 从第三方仓库动态下载并执行安装代码（供应链风险）。
#
